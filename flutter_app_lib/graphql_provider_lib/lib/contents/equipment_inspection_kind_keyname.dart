// equipment_inspection_kind_keyname.dart
//
// ignore_for_file: constant_identifier_names
// 要件0018・0021により、定数名はフラットキーの`||`区切りをそのまま`_`に置き換えた
// 名前にする(lowerCamelCase強制のlintは意図的に無効化している)。
//
// lib/graphql/equipment_inspection_kind/equipment_inspection_kind_read.graphql /
// equipment_inspection_kind_edit.graphql の結果を nested_map_flattener.dart で
// 平坦化したときのキー文字列の定数クラス。
// ⚠ 実スキーマの型名は"MstrInspectionKind"(要件0026で新規追加されたテーブル)。
//
// 対象画面: source/views.md #equipment_inspection_kind (read / edit)
import 'content_variable.dart';

abstract class EquipmentInspectionKindKeyName {
  /// 点検整備区分ID
  static const ContentVariable mstrInspectionKindId = ContentVariable(
