// customer_contact_keyname.dart
//
// ignore_for_file: constant_identifier_names
// 要件0018・0021により、定数名はフラットキーの`||`区切りをそのまま`_`に置き換えた
// 名前にする(lowerCamelCase強制のlintは意図的に無効化している)。
//
// lib/graphql/customer_contact/customer_contact_read.graphql /
// customer_contact_edit.graphql の結果を nested_map_flattener.dart で
// 平坦化したときのキー文字列の定数クラス。
// ⚠ docs/0025_view_graphql_evaluation_log.md / docs/0026_schema_fetch_log.md: 実スキーマの
//   型名は"MstrStakeholderContact"(customer_contact/supplier_contactは同一物理テーブルを共有)。
//   事業所名/部署名/担当者氏名はそれぞれ独立したshared_appellations参照。
//
// 対象画面: source/views.md #customer_contact (read / edit)
abstract class CustomerContactKeyName {
  /// 窓口ID
