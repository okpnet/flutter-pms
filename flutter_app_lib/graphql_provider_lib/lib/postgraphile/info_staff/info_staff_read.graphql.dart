...
class Variables$Query$InfoStaffReadOffice {
  factory Variables$Query$InfoStaffReadOffice({required String infoOfficeId}) =>
      Variables$Query$InfoStaffReadOffice._({r'infoOfficeId': infoOfficeId});

  Variables$Query$InfoStaffReadOffice._(this._$data);

  factory Variables$Query$InfoStaffReadOffice.fromJson(
    Map<String, dynamic> data,
  ) {
    final result$data = <String, dynamic>{};
    final l$infoOfficeId = data['infoOfficeId'];
    result$data['infoOfficeId'] = (l$infoOfficeId as String);
    return Variables$Query$InfoStaffReadOffice._(result$data);
  }
  ...
  CopyWith$Variables$Query$InfoStaffReadOffice<
    Variables$Query$InfoStaffReadOffice
  >
  get copyWith => CopyWith$Variables$Query$InfoStaffReadOffice(this, (i) => i);
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Query$InfoStaffReadOffice ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$infoOfficeId = infoOfficeId;
  ...
  int get hashCode {
    final l$infoOfficeId = infoOfficeId;
    return Object.hashAll([l$infoOfficeId]);
  }
}

abstract class CopyWith$Variables$Query$InfoStaffReadOffice<TRes> {
  factory CopyWith$Variables$Query$InfoStaffReadOffice(
    Variables$Query$InfoStaffReadOffice instance,
    TRes Function(Variables$Query$InfoStaffReadOffice) then,
  ) = _CopyWithImpl$Variables$Query$InfoStaffReadOffice;

  factory CopyWith$Variables$Query$InfoStaffReadOffice.stub(TRes res) =
      _CopyWithStubImpl$Variables$Query$InfoStaffReadOffice;

  TRes call({String? infoOfficeId});
}

class _CopyWithImpl$Variables$Query$InfoStaffReadOffice<TRes>
    implements CopyWith$Variables$Query$InfoStaffReadOffice<TRes> {
  _CopyWithImpl$Variables$Query$InfoStaffReadOffice(this._instance, this._then);

  final Variables$Query$InfoStaffReadOffice _instance;

  final TRes Function(Variables$Query$InfoStaffReadOffice) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? infoOfficeId = _undefined}) => _then(
    Variables$Query$InfoStaffReadOffice._({
      ..._instance._$data,
...
class _CopyWithStubImpl$Variables$Query$InfoStaffReadOffice<TRes>
    implements CopyWith$Variables$Query$InfoStaffReadOffice<TRes> {
  _CopyWithStubImpl$Variables$Query$InfoStaffReadOffice(this._res);

  TRes _res;

  call({String? infoOfficeId}) => _res;
}

class Query$InfoStaffReadOffice {
  Query$InfoStaffReadOffice({
    this.infoOfficeByInfoOfficeId,
    this.$__typename = 'Query',
  });

  factory Query$InfoStaffReadOffice.fromJson(Map<String, dynamic> json) {
    final l$infoOfficeByInfoOfficeId = json['infoOfficeByInfoOfficeId'];
    final l$$__typename = json['__typename'];
    return Query$InfoStaffReadOffice(
      infoOfficeByInfoOfficeId: l$infoOfficeByInfoOfficeId == null
          ? null
          : Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId.fromJson(
  ...
  final Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId?
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$InfoStaffReadOffice ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$infoOfficeByInfoOfficeId = infoOfficeByInfoOfficeId;
...
extension UtilityExtension$Query$InfoStaffReadOffice
    on Query$InfoStaffReadOffice {
  CopyWith$Query$InfoStaffReadOffice<Query$InfoStaffReadOffice> get copyWith =>
      CopyWith$Query$InfoStaffReadOffice(this, (i) => i);
}

abstract class CopyWith$Query$InfoStaffReadOffice<TRes> {
  factory CopyWith$Query$InfoStaffReadOffice(
    Query$InfoStaffReadOffice instance,
    TRes Function(Query$InfoStaffReadOffice) then,
  ) = _CopyWithImpl$Query$InfoStaffReadOffice;

  factory CopyWith$Query$InfoStaffReadOffice.stub(TRes res) =
      _CopyWithStubImpl$Query$InfoStaffReadOffice;

  TRes call({
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId?
    infoOfficeByInfoOfficeId,
    String? $__typename,
  });
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<TRes>
  get infoOfficeByInfoOfficeId;
}

class _CopyWithImpl$Query$InfoStaffReadOffice<TRes>
    implements CopyWith$Query$InfoStaffReadOffice<TRes> {
  _CopyWithImpl$Query$InfoStaffReadOffice(this._instance, this._then);

  final Query$InfoStaffReadOffice _instance;

  final TRes Function(Query$InfoStaffReadOffice) _then;
  ...
  TRes call({
    ...
    Query$InfoStaffReadOffice(
      infoOfficeByInfoOfficeId: infoOfficeByInfoOfficeId == _undefined
          ...
          : (infoOfficeByInfoOfficeId
                as Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get infoOfficeByInfoOfficeId {
    ...
    return local$infoOfficeByInfoOfficeId == null
        ? CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId.stub(
            _then(_instance),
          )
        : CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
...
class _CopyWithStubImpl$Query$InfoStaffReadOffice<TRes>
    implements CopyWith$Query$InfoStaffReadOffice<TRes> {
  _CopyWithStubImpl$Query$InfoStaffReadOffice(this._res);
  ...
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<TRes>
  get infoOfficeByInfoOfficeId =>
      CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId.stub(_res);
}

const documentNodeQueryInfoStaffReadOffice = DocumentNode(
  definitions: [
    OperationDefinitionNode(
      type: OperationType.query,
      name: NameNode(value: 'InfoStaffReadOffice'),
      variableDefinitions: [
        VariableDefinitionNode(
...
Query$InfoStaffReadOffice _parserFn$Query$InfoStaffReadOffice(
  Map<String, dynamic> data,
) => Query$InfoStaffReadOffice.fromJson(data);
typedef OnQueryComplete$Query$InfoStaffReadOffice =
    FutureOr<void> Function(Map<String, dynamic>?, Query$InfoStaffReadOffice?);

class Options$Query$InfoStaffReadOffice
    extends graphql.QueryOptions<Query$InfoStaffReadOffice> {
  Options$Query$InfoStaffReadOffice({
    String? operationName,
    required Variables$Query$InfoStaffReadOffice variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Query$InfoStaffReadOffice? typedOptimisticResult,
    Duration? pollInterval,
    graphql.Context? context,
    OnQueryComplete$Query$InfoStaffReadOffice? onComplete,
    graphql.OnQueryError? onError,
  }) : onCompleteWithParsed = onComplete,
       super(
         variables: variables.toJson(),
         ...
         onComplete: onComplete == null
             ...
             : (data) => onComplete(
                 ...
                 data == null
                     ? null
                     : _parserFn$Query$InfoStaffReadOffice(data),
               ),
         onError: onError,
         document: documentNodeQueryInfoStaffReadOffice,
         parserFn: _parserFn$Query$InfoStaffReadOffice,
       );

  final OnQueryComplete$Query$InfoStaffReadOffice? onCompleteWithParsed;
...
class WatchOptions$Query$InfoStaffReadOffice
    extends graphql.WatchQueryOptions<Query$InfoStaffReadOffice> {
  WatchOptions$Query$InfoStaffReadOffice({
    String? operationName,
    required Variables$Query$InfoStaffReadOffice variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Query$InfoStaffReadOffice
    extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$InfoStaffReadOffice({
    required graphql.UpdateQuery updateQuery,
    required Variables$Query$InfoStaffReadOffice variables,
  }) : super(
         updateQuery: updateQuery,
...
extension ClientExtension$Query$InfoStaffReadOffice on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$InfoStaffReadOffice>>
  query$InfoStaffReadOffice(Options$Query$InfoStaffReadOffice options) async =>
      await this.query(options);

  graphql.ObservableQuery<Query$InfoStaffReadOffice>
  watchQuery$InfoStaffReadOffice(
    WatchOptions$Query$InfoStaffReadOffice options,
  ) => this.watchQuery(options);

  void writeQuery$InfoStaffReadOffice({
    required Query$InfoStaffReadOffice data,
    required Variables$Query$InfoStaffReadOffice variables,
    bool broadcast = true,
  }) => this.writeQuery(
    graphql.Request(
  ...
  Query$InfoStaffReadOffice? readQuery$InfoStaffReadOffice({
    required Variables$Query$InfoStaffReadOffice variables,
    bool optimistic = true,
  }) {
    final result = this.readQuery(
    ...
    return result == null ? null : Query$InfoStaffReadOffice.fromJson(result);
  }
}

graphql_flutter.QueryHookResult<Query$InfoStaffReadOffice>
useQuery$InfoStaffReadOffice(Options$Query$InfoStaffReadOffice options) =>
    graphql_flutter.useQuery(options);
graphql.ObservableQuery<Query$InfoStaffReadOffice>
useWatchQuery$InfoStaffReadOffice(
  WatchOptions$Query$InfoStaffReadOffice options,
) => graphql_flutter.useWatchQuery(options);

class Query$InfoStaffReadOffice$Widget
    extends graphql_flutter.Query<Query$InfoStaffReadOffice> {
  Query$InfoStaffReadOffice$Widget({
    widgets.Key? key,
    required Options$Query$InfoStaffReadOffice options,
    required graphql_flutter.QueryBuilder<Query$InfoStaffReadOffice> builder,
  }) : super(key: key, options: options, builder: builder);
}

class Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId {
  Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId({
  ...
  factory Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$infoOfficeId = json['infoOfficeId'];
    final l$sharedAppellationBySharedAppellationsId =
        json['sharedAppellationBySharedAppellationsId'];
    final l$$__typename = json['__typename'];
    return Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
      infoOfficeId: (l$infoOfficeId as String),
      sharedAppellationBySharedAppellationsId:
          l$sharedAppellationBySharedAppellationsId == null
          ? null
          : Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId.fromJson(
              (l$sharedAppellationBySharedAppellationsId
                  as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
  ...
  final Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId?
  sharedAppellationBySharedAppellationsId;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$infoOfficeId = infoOfficeId;
...
extension UtilityExtension$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId
    on Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId {
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId
  >
  get copyWith => CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
    this,
    (i) => i,
  );
}

abstract class CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<
  TRes
> {
  factory CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId instance,
    TRes Function(Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId) then,
  ) = _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId;

  factory CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId;

  TRes call({
    String? infoOfficeId,
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId?
    sharedAppellationBySharedAppellationsId,
    String? $__typename,
  });
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
    TRes
  >
  get sharedAppellationBySharedAppellationsId;
}

class _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<TRes>
    implements
        CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<TRes> {
  _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
    this._instance,
  ...
  final Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId _instance;

  final TRes Function(Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId) _then;
  ...
  TRes call({
    ...
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
      ...
      sharedAppellationBySharedAppellationsId:
          ...
          ? _instance.sharedAppellationBySharedAppellationsId
          : (sharedAppellationBySharedAppellationsId
                as Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get sharedAppellationBySharedAppellationsId {
    final local$sharedAppellationBySharedAppellationsId =
        _instance.sharedAppellationBySharedAppellationsId;
    return local$sharedAppellationBySharedAppellationsId == null
        ? CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId.stub(
            _then(_instance),
          )
        : CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId(
            local$sharedAppellationBySharedAppellationsId,
...
class _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<TRes>
    implements
        CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId<TRes> {
  _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId(
    this._res,
...
class Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId {
  Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId({
    this.sharedDictionaryBySharedDictionaryNameId,
    this.$__typename = 'SharedAppellation',
  });

  factory Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$sharedDictionaryBySharedDictionaryNameId =
        json['sharedDictionaryBySharedDictionaryNameId'];
    final l$$__typename = json['__typename'];
    return Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId(
      sharedDictionaryBySharedDictionaryNameId:
          l$sharedDictionaryBySharedDictionaryNameId == null
          ? null
          : Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId.fromJson(
              (l$sharedDictionaryBySharedDictionaryNameId
                  as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
  ...
  final Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId?
  sharedDictionaryBySharedDictionaryNameId;
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$sharedDictionaryBySharedDictionaryNameId =
...
extension UtilityExtension$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId
    on
        Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId {
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId
...
abstract class CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
  TRes
> {
  factory CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId(
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId
    instance,
    TRes Function(
      Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId,
    ...
    then,
  ) = _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId;

  factory CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId;

  TRes call({
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId?
    sharedDictionaryBySharedDictionaryNameId,
    String? $__typename,
  });
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
    TRes
  >
  get sharedDictionaryBySharedDictionaryNameId;
}

class _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
  TRes
>
    implements
        CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
  ...
  TRes call({
    ...
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId(
      sharedDictionaryBySharedDictionaryNameId:
          ...
          ? _instance.sharedDictionaryBySharedDictionaryNameId
          : (sharedDictionaryBySharedDictionaryNameId
                as Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get sharedDictionaryBySharedDictionaryNameId {
    final local$sharedDictionaryBySharedDictionaryNameId =
        _instance.sharedDictionaryBySharedDictionaryNameId;
    return local$sharedDictionaryBySharedDictionaryNameId == null
        ? CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId.stub(
            _then(_instance),
          )
        : CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId(
            local$sharedDictionaryBySharedDictionaryNameId,
...
class _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
  TRes
>
    implements
        CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId<
...
class Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId {
  Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId({
    this.ja,
    this.en,
    this.$__typename = 'SharedDictionary',
  ...
  factory Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$ja = json['ja'];
    final l$en = json['en'];
    final l$$__typename = json['__typename'];
    return Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId(
      ja: (l$ja as String?),
      en: (l$en as String?),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$ja = ja;
...
extension UtilityExtension$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId
    on
        Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId {
  CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId
...
abstract class CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
  TRes
> {
  factory CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId(
    Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId
    instance,
    TRes Function(
      Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId,
    ...
    then,
  ) = _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId;

  factory CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId;

  TRes call({String? ja, String? en, String? $__typename});
}

class _CopyWithImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
  TRes
>
    implements
        CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
...
class _CopyWithStubImpl$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
  TRes
>
    implements
        CopyWith$Query$InfoStaffReadOffice$infoOfficeByInfoOfficeId$sharedAppellationBySharedAppellationsId$sharedDictionaryBySharedDictionaryNameId<
