...
create table tests.shared_language_code (
    shared_language_code_id uuid default gen_random_uuid(),
    code varchar(16) not null,
    label varchar(255) not null,
    priority smallint not null,
    is_default boolean default 'f',
...
create table tests.history_mstr_spec_measurement (
    history_id uuid default gen_random_uuid(),
...
create table tests.history_mstr_envelope_measurement (
    history_id uuid default gen_random_uuid(),
...
create table tests.history_mstr_equipment_envelope (
    history_id uuid default gen_random_uuid(),
...
create table tests.mstr_spec_measurement (
...
create table tests.mstr_envelope_measurement (
...
create table tests.mstr_equipment_envelope (
...
create table tests.trans_shipping_order_detail_record (
    trans_shipping_order_detail_record_id uuid default gen_random_uuid(),
...
create table tests.hrchy_mstr_document_content (
    hrchy_mstr_document_content_id uuid default gen_random_uuid(),
...
create table tests.history_mstr_item_actual_size (
    history_id uuid default gen_random_uuid(),
    mstr_item_actual_size_id uuid not null,
    mstr_item_id uuid not null,
    mstr_item_size_kind_id uuid not null,
...
create table tests.history_mstr_stakeholder_contact (
    ...
    code varchar(255) not null,
    office_appellations_id uuid default null,
    department_appellations_id uuid default null,
...
create table tests.history_info_position (
    history_id uuid default gen_random_uuid(),
    info_position_id uuid not null,
    priority smallint not null,
    shared_appellations_id uuid not null,
...
create table tests.trans_prevention_detail (
    trans_prevetion_detail_id uuid default gen_random_uuid(),
    trans_risk_id uuid not null,
...
create table tests.trans_equipment_lent (
    ...
    equipment_history_id uuid not null,
    mstr_equipment_id uuid not null,
    info_staff_id uuid not null,
...
create table tests.trans_complaint_stakeholder_adapter (
    trans_complaint_stakeholder_adapter_id uuid default gen_random_uuid(),
    trans_complaint_id uuid not null,
    mstr_stakeholder_id uuid not null,
    name varchar(255) default null,
    number varchar(255) default null,
...
create table tests.trans_complaint_equipment_adapter (
    trans_complaint_equipment_adapter_id uuid default gen_random_uuid(),
    trans_complaint_id uuid not null,
    mstr_equipment_id uuid not null,
    name varchar(255) default null,
    number varchar(255) default null,
...
create table tests.trans_complaint_order_adapter (
    trans_complaint_order_adapter_id uuid default gen_random_uuid(),
    trans_complaint_id uuid not null,
    trans_order_id uuid not null,
    name varchar(255) default null,
    number varchar(255) default null,
...
create table tests.mstr_item_actual_size (
    mstr_item_actual_size_id uuid default gen_random_uuid(),
    mstr_item_id uuid not null,
    mstr_item_size_kind_id uuid not null,
    size_value decimal(10,4) default 0.0,
    detail varchar(1024) default null,
...
create table tests.trans_shipping_order_detail (
    trans_shipping_order_detail_id uuid default gen_random_uuid(),
...
create table tests.trans_ship_order (
    ...
    trans_order_id uuid not null,
    edtimated_shipping_date timestamp not null,
    code varchar(255) not null,
...
create table tests.trans_inventory_apply (
    ...
    register_at timestamp default now(),
    trans_inventory_request_id uuid default null,
...
create table tests.trans_order (
    ...
    mstr_stakholder_id uuid default null,
    contact_history_id uuid default null,
    mstr_stakeholder_concat_id uuid default null,
    control_code_1 varchar(255) default null,
    control_code_2 varchar(255) default null,
    control_code_3 varchar(255) default null,
...
comment on column tests.shared_dictionary_value.update_user_history_id is '更新者履歴ID';
comment on column tests.shared_dictionary_value.remove is '削除';
comment on table tests.shared_language_code is '言語コード';
comment on column tests.shared_language_code.shared_language_code_id is '言語コードID';
comment on column tests.shared_language_code.code is '言語コード';
...
comment on column tests.shared_language_code.update_user_history_id is '更新者履歴ID';
comment on column tests.shared_language_code.remove is '削除';
...
comment on column tests.history_mstr_inspection_kind.update_user_history_id is '更新者履歴ID';
comment on column tests.history_mstr_inspection_kind.remove is '削除';
...
comment on column tests.mstr_inspection_kind.update_user_history_id is '更新者履歴ID';
comment on column tests.mstr_inspection_kind.remove is '削除';
...
comment on column tests.history_mstr_packing_spec.update_user_history_id is '更新者履歴ID';
comment on column tests.history_mstr_packing_spec.remove is '削除';
comment on table tests.history_mstr_spec_measurement is '梱包サイズ大きさマスタ履歴';
comment on column tests.history_mstr_spec_measurement.history_id is '履歴ID';
...
comment on column tests.history_mstr_spec_measurement.update_user_history_id is '更新者履歴ID';
comment on column tests.history_mstr_spec_measurement.remove is '削除';
comment on table tests.history_mstr_envelope_measurement is '設備占有範囲量マスタ履歴';
comment on column tests.history_mstr_envelope_measurement.history_id is '履歴ID';
...
comment on column tests.history_mstr_envelope_measurement.update_user_history_id is '更新者履歴ID';
comment on column tests.history_mstr_envelope_measurement.remove is '削除';
comment on table tests.history_mstr_equipment_envelope is '設備占有範囲マスタ履歴';
comment on column tests.history_mstr_equipment_envelope.history_id is '履歴ID';
...
comment on column tests.history_mstr_equipment_envelope.update_user_history_id is '更新者履歴ID';
comment on column tests.history_mstr_equipment_envelope.remove is '削除';
comment on table tests.mstr_spec_measurement is '梱包サイズ大きさマスタ';
...
comment on column tests.mstr_spec_measurement.update_user_history_id is '更新者履歴ID';
...
comment on column tests.mstr_packing_spec.update_user_history_id is '更新者履歴ID';
comment on column tests.mstr_packing_spec.remove is '削除';
comment on table tests.mstr_envelope_measurement is '設備占有範囲量マスタ';
...
comment on column tests.mstr_envelope_measurement.update_user_history_id is '更新者履歴ID';
comment on column tests.mstr_envelope_measurement.remove is '削除';
comment on table tests.mstr_equipment_envelope is '設備占有範囲マスタ';
...
comment on column tests.mstr_equipment_envelope.update_user_history_id is '更新者履歴ID';
comment on column tests.mstr_equipment_envelope.remove is '削除';
comment on table tests.trans_shipping_order_detail_record is '出荷明細実績';
comment on column tests.trans_shipping_order_detail_record.trans_shipping_order_detail_record_id is '出荷明細実績ID';
...
comment on column tests.trans_shipping_order_detail_record.update_user_history_id is '更新者履歴ID';
comment on column tests.trans_shipping_order_detail_record.remove is '削除';
...
comment on column tests.shared_appellations.shared_dictionary_name_id is '名前';
...
comment on column tests.hrchy_mstr_document_content.hrchy_mstr_document_content_id is '文書コンテンツ階層ID';
...
comment on column tests.history_info_assign.info_position_id is '役割ID';
comment on column tests.history_info_assign.info_office_id is '事業所ID';
...
comment on column tests.history_mstr_inspection.external_inspection is '外部点検整備';
...
comment on table tests.history_mstr_item_actual_size is '品目大きさマスタ履歴';
comment on column tests.history_mstr_item_actual_size.history_id is '履歴ID';
comment on column tests.history_mstr_item_actual_size.mstr_item_actual_size_id is '大きさID';
comment on column tests.history_mstr_item_actual_size.mstr_item_id is '品目ID';
...
comment on column tests.history_mstr_item_actual_size.update_user_history_id is '更新者履歴ID';
comment on column tests.history_mstr_item_actual_size.remove is '削除';
...
comment on column tests.history_mstr_stakeholder_contact.office_appellations_id is '事業所名';
comment on column tests.history_mstr_stakeholder_contact.department_appellations_id is '部署名';
...
comment on table tests.history_info_position is '役割履歴';
...
comment on column tests.history_info_position.update_user_history_id is '更新者履歴ID';
comment on column tests.history_info_position.remove is '削除';
...
comment on column tests.info_position.update_user_history_id is '更新者履歴ID';
...
comment on table tests.trans_prevention_detail is '未然防止処置';
comment on column tests.trans_prevention_detail.trans_prevetion_detail_id is '未然防止処置ID';
comment on column tests.trans_prevention_detail.trans_risk_id is 'リスクID';
comment on column tests.trans_prevention_detail.trans_prevention_id is '未然防止ID';
comment on column tests.trans_prevention_detail.info_department_id is '組織情報ID';
comment on column tests.trans_prevention_detail.start_at is '開始日';
comment on column tests.trans_prevention_detail.stop_at is '終了日';
comment on column tests.trans_prevention_detail.name is '名前';
...
comment on column tests.trans_prevention_detail.update_user_history_id is '更新者履歴ID';
comment on column tests.trans_prevention_detail.remove is '削除';
comment on table tests.trans_prevention is '未然防止';
comment on column tests.trans_prevention.trans_prevention_id is '未然防止ID';
comment on column tests.trans_prevention.trans_risk_id is 'リスクID';
...
comment on column tests.trans_order_risk.trans_risk_id is 'リスクID';
...
comment on column tests.trans_complaint_stakeholder_adapter.trans_complaint_id is '異常ID';
comment on column tests.trans_complaint_stakeholder_adapter.mstr_stakeholder_id is '利害関係者ID';
...
comment on column tests.trans_complaint_equipment_adapter.trans_complaint_id is '異常ID';
comment on column tests.trans_complaint_equipment_adapter.mstr_equipment_id is '設備ID';
...
comment on column tests.trans_complaint_process_adapter.trans_complaint_id is '異常ID';
comment on column tests.trans_complaint_process_adapter.mstr_task_id is '工程ID';
...
comment on column tests.trans_complaint_order_adapter.trans_complaint_id is '異常ID';
...
comment on column tests.mstr_inspection.external_inspection is '外部点検整備';
...
comment on column tests.info_assign.info_position_id is '役割ID';
comment on column tests.info_assign.info_office_id is '事業所ID';
...
comment on table tests.mstr_item_actual_size is '品目大きさマスタ';
comment on column tests.mstr_item_actual_size.mstr_item_actual_size_id is '大きさID';
comment on column tests.mstr_item_actual_size.mstr_item_id is '品目ID';
comment on column tests.mstr_item_actual_size.mstr_item_size_kind_id is '品目大きさ区分ID';
...
comment on column tests.mstr_item_actual_size.update_user_history_id is '更新者履歴ID';
comment on column tests.mstr_item_actual_size.remove is '削除';
...
comment on table tests.trans_shipping_order_detail is '出荷オーダー明細';
comment on column tests.trans_shipping_order_detail.trans_shipping_order_detail_id is '出荷オーダー明細ID';
comment on column tests.trans_shipping_order_detail.trans_shipping_id is '出荷ID';
comment on column tests.trans_shipping_order_detail.trans_order_detail_id is '受注明細ID';
...
comment on column tests.trans_shipping_order_detail.update_user_history_id is '更新者履歴ID';
comment on column tests.trans_shipping_order_detail.remove is '削除';
...
comment on column tests.trans_order.mstr_stakholder_id is '顧客ID';
comment on column tests.trans_order.contact_history_id is '顧客窓口履歴ID';
comment on column tests.trans_order.mstr_stakeholder_concat_id is '顧客窓口ID';
...
comment on column tests.mstr_stakeholder_contact.office_appellations_id is '事業所名';
comment on column tests.mstr_stakeholder_contact.department_appellations_id is '部署名';
comment on column tests.mstr_stakeholder_contact.contact_person_appellations_id is '担当者名';
comment on column tests.mstr_stakeholder_contact.mail is 'メール';
...
alter table tests.hrchy_mstr_document_content
    add constraint hrchy_mstr_document_content_PKC primary key (hrchy_mstr_document_content_id);
...
alter table tests.shared_language_code add constraint shared_language_code_FK1 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_mstr_spec_measurement add constraint history_mstr_spec_measurement_FK1 foreign key (mstr_spec_measurement_id) references tests.mstr_spec_measurement (mstr_spec_measurement_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_spec_measurement add constraint history_mstr_spec_measurement_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_envelope_measurement add constraint history_mstr_envelope_measurement_FK1 foreign key (mstr_envelope_measurement_id) references tests.mstr_envelope_measurement (mstr_envelope_measurement_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_envelope_measurement add constraint history_mstr_envelope_measurement_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_envelope add constraint history_mstr_equipment_envelope_FK1 foreign key (mstr_equipment_envelope_id) references tests.mstr_equipment_envelope (mstr_equipment_envelope_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_shipping_order_detail_record add constraint trans_shipping_order_detail_record_FK1 foreign key (trans_shipping_order_detail_id) references tests.trans_shipping_order_detail (trans_shipping_order_detail_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.shared_appellations add constraint shared_appellations_FK1 foreign key (shared_dictionary_name_id) references tests.shared_dictionary (shared_dictionary_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.shared_appellations add constraint shared_appellations_FK2 foreign key (shared_dictionary_nickname_id) references tests.shared_dictionary (shared_dictionary_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.shared_appellations add constraint shared_appellations_FK3 foreign key (shared_dictionary_pronunciation_id) references tests.shared_dictionary (shared_dictionary_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.shared_appellations add constraint shared_appellations_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_shared_dictionary add constraint history_shared_dictionary_FK1 foreign key (shared_dictionary_id) references tests.shared_dictionary (shared_dictionary_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_shared_dictionary add constraint history_shared_dictionary_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_mstr_document_content_tree add constraint history_mstr_document_content_tree_FK1 foreign key (mstr_document_content_tree_id) references tests.mstr_document_content_tree (mstr_document_content_tree_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_document_content_tree add constraint history_mstr_document_content_tree_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_document_content add constraint history_mstr_document_content_FK1 foreign key (mstr_document_content_id) references tests.mstr_document_content (mstr_document_content_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_document_content add constraint history_mstr_document_content_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.mstr_document_tree add constraint mstr_document_tree_FK2 foreign key (mstr_document_id) references tests.mstr_document (mstr_document_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_mstr_location_tree add constraint history_mstr_location_tree_FK1 foreign key (mstr_location_tree_id) references tests.mstr_location_tree (mstr_location_tree_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_location_tree add constraint history_mstr_location_tree_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_location_tree add constraint mstr_location_tree_FK1 foreign key (parent_mstr_location_id) references tests.mstr_location (mstr_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_location_tree add constraint mstr_location_tree_FK2 foreign key (mstr_location_id) references tests.mstr_location (mstr_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_location_tree add constraint mstr_location_tree_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_department_tree add constraint history_info_department_tree_FK1 foreign key (info_department_tree_id) references tests.info_department_tree (info_department_tree_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_department_tree add constraint history_info_department_tree_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_department_tree add constraint info_department_tree_FK1 foreign key (parent_info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_department_tree add constraint info_department_tree_FK2 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_mstr_inspection_operation_task add constraint history_mstr_inspection_operation_task_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_inspection_operation_task add constraint mstr_inspection_operation_task_FK1 foreign key (mstr_inspection_id) references tests.mstr_inspection (mstr_inspection_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_inspection_operation_task add constraint mstr_inspection_operation_task_FK2 foreign key (mstr_inspection_operation_id) references tests.mstr_inspection_operation (mstr_inspection_operation_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_inspection_operation_task add constraint mstr_inspection_operation_task_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_department_access_permission add constraint history_info_department_access_permission_FK1 foreign key (info_department_access_permission_id) references tests.info_department_access_permission (info_department_access_permission_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_department_access_permission add constraint history_info_department_access_permission_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_department_access_permission add constraint info_department_access_permission_FK1 foreign key (info_access_path_id) references tests.info_access_path (info_access_path_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_department_access_permission add constraint info_department_access_permission_FK2 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_department_access_permission add constraint info_department_access_permission_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_assign add constraint history_info_assign_FK1 foreign key (info_assign_id) references tests.info_assign (info_assign_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_assign add constraint history_info_assign_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_item_provision add constraint mstr_item_provision_FK1 foreign key (info_provision_id) references tests.info_provision (info_provision_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_item_provision add constraint mstr_item_provision_FK2 foreign key (mstr_item_id) references tests.mstr_item (mstr_item_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_item_provision add constraint mstr_item_provision_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_item_provision add constraint history_mstr_item_provision_FK1 foreign key (mstr_item_provision_id) references tests.mstr_item_provision (mstr_item_provision_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_item_provision add constraint history_mstr_item_provision_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_provision add constraint history_mstr_equipment_provision_FK1 foreign key (mstr_equipment_provision_id) references tests.mstr_equipment_provision (mstr_equipment_provision_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_provision add constraint history_mstr_equipment_provision_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.info_app_status add constraint info_app_status_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_announcement add constraint trans_announcement_FK1 foreign key (for_info_staff_id) references tests.info_staff (info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_announcement add constraint trans_announcement_FK2 foreign key (to_info_staff_id) references tests.info_staff (info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_announcement add constraint trans_announcement_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_operation_task add constraint history_mstr_operation_task_FK1 foreign key (mstr_operation_task_id) references tests.mstr_operation_task (mstr_operation_task_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_operation_task add constraint history_mstr_operation_task_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_report add constraint history_mstr_report_FK1 foreign key (mstr_report_id) references tests.mstr_report (mstr_report_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_report add constraint history_mstr_report_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_item_operation_task add constraint history_mstr_item_operation_task_FK1 foreign key (mstr_item_operation_task_id) references tests.mstr_item_operation_task (mstr_item_operation_task_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_item_operation_task add constraint history_mstr_item_operation_task_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task_tree add constraint history_mstr_task_tree_FK1 foreign key (mstr_task_tree_id) references tests.mstr_task_tree (mstr_task_tree_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task_tree add constraint history_mstr_task_tree_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_outsource_available add constraint history_mstr_outsource_available_FK1 foreign key (mstr_outsource_available_id) references tests.mstr_outsource_available (mstr_outsource_available_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_outsource_available add constraint history_mstr_outsource_available_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_available add constraint history_mstr_equipment_available_FK1 foreign key (mstr_equipment_available_id) references tests.mstr_equipment_available (mstr_equipment_available_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_available add constraint history_mstr_equipment_available_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task add constraint history_mstr_task_FK1 foreign key (mstr_task_id) references tests.mstr_task (mstr_task_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task add constraint history_mstr_task_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task_location add constraint history_mstr_task_location_FK1 foreign key (mstr_task_location_id) references tests.mstr_task_location (mstr_task_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task_location add constraint history_mstr_task_location_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_task_location add constraint mstr_task_location_FK1 foreign key (mstr_equipment_id) references tests.mstr_equipment (mstr_equipment_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_task_location add constraint mstr_task_location_FK2 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_task_location add constraint mstr_task_location_FK3 foreign key (mstr_location_id) references tests.mstr_location (mstr_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_task_location add constraint mstr_task_location_FK4 foreign key (mstr_stakeholder_id) references tests.mstr_stakeholder (mstr_stakeholder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_task_location add constraint mstr_task_location_FK5 foreign key (mstr_task_id) references tests.mstr_task (mstr_task_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_task_location add constraint mstr_task_location_FK6 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task_group add constraint history_mstr_task_group_FK1 foreign key (mstr_task_group_id) references tests.mstr_task_group (mstr_task_group_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_task_group add constraint history_mstr_task_group_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_operation add constraint history_mstr_operation_FK1 foreign key (mstr_operation_id) references tests.mstr_operation (mstr_operation_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_operation add constraint history_mstr_operation_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_manufacturer add constraint history_mstr_manufacturer_FK1 foreign key (mstr_manufacturer_id) references tests.mstr_manufacturer (mstr_manufacturer_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_manufacturer add constraint history_mstr_manufacturer_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_inspection add constraint history_mstr_inspection_FK1 foreign key (mstr_inspection_id) references tests.mstr_inspection (mstr_inspection_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_inspection add constraint history_mstr_inspection_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_inspection_formula add constraint history_mstr_inspection_formula_FK1 foreign key (mstr_inspection_formula_id) references tests.mstr_inspection_formula (mstr_inspection_formula_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_inspection_formula add constraint history_mstr_inspection_formula_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_item_actual_size add constraint history_mstr_item_actual_size_FK1 foreign key (mstr_item_actual_size_id) references tests.mstr_item_actual_size (mstr_item_actual_size_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_mstr_audit_std add constraint history_mstr_audit_std_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_location add constraint history_mstr_location_FK1 foreign key (mstr_location_id) references tests.mstr_location (mstr_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_location add constraint history_mstr_location_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_tag add constraint history_mstr_equipment_tag_FK1 foreign key (mstr_equipment_tag_id) references tests.mstr_equipment_tag (mstr_equipment_tag_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_equipment_tag add constraint history_mstr_equipment_tag_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_stakeholder_contact add constraint history_mstr_stakeholder_contact_FK1 foreign key (mstr_stakeholder_contact_id) references tests.mstr_stakeholder_contact (mstr_stakeholder_contact_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_stakeholder_contact add constraint history_mstr_stakeholder_contact_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_stakeholder_provision add constraint history_mstr_stakeholder_provision_FK1 foreign key (mstr_stakeholder_provision_id) references tests.mstr_stakeholder_provision (mstr_stakeholder_provision_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_stakeholder_provision add constraint history_mstr_stakeholder_provision_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_stakeholder add constraint history_mstr_stakeholder_FK1 foreign key (mstr_stakeholder_id) references tests.mstr_stakeholder (mstr_stakeholder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_stakeholder add constraint history_mstr_stakeholder_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_staff_license add constraint history_mstr_staff_license_FK1 foreign key (mstr_staff_license_id) references tests.mstr_staff_license (mstr_staff_license_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_staff_license add constraint history_mstr_staff_license_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_license add constraint history_mstr_license_FK1 foreign key (mstr_license_id) references tests.mstr_license (mstr_license_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_mstr_capability add constraint history_mstr_capability_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_approval_pattern_detail add constraint history_mstr_approval_pattern_detail_FK1 foreign key (mstr_approval_pattern_detail_id) references tests.mstr_approval_pattern_detail (mstr_approval_pattern_detail_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_approval_pattern_detail add constraint history_mstr_approval_pattern_detail_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_approval add constraint history_mstr_approval_FK1 foreign key (mstr_approval_id) references tests.mstr_approval (mstr_approval_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_approval add constraint history_mstr_approval_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_position add constraint history_info_position_FK1 foreign key (info_position_id) references tests.info_position (info_position_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_position add constraint history_info_position_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_mstr_staff_capability add constraint history_mstr_staff_capability_FK1 foreign key (mstr_staff_capability_id,info_staff_id) references tests.mstr_staff_capability (mstr_staff_capability_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.history_info_address add constraint history_info_address_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_shared_unit add constraint history_shared_unit_FK1 foreign key (shared_unit_id) references tests.shared_unit (shared_unit_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_shared_unit add constraint history_shared_unit_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_office add constraint history_info_office_FK1 foreign key (info_office_id) references tests.info_office (info_office_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_office add constraint history_info_office_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_department add constraint history_info_department_FK1 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_department add constraint history_info_department_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_access_path_approval add constraint history_info_access_path_approval_FK1 foreign key (info_access_path_approval_id) references tests.info_access_path_approval (info_access_path_approval_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_access_path_approval add constraint history_info_access_path_approval_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.history_info_access_path add constraint history_info_access_path_FK1 foreign key (info_access_path_id) references tests.info_access_path (info_access_path_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_anonymouse add constraint trans_anonymouse_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_file_reminder add constraint trans_file_reminder_FK1 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_equipment_available add constraint mstr_equipment_available_FK1 foreign key (mstr_task_location_id) references tests.mstr_task_location (mstr_task_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_equipment_available add constraint mstr_equipment_available_FK2 foreign key (mstr_equipment_id) references tests.mstr_equipment (mstr_equipment_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_equipment_available add constraint mstr_equipment_available_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_unrecognized_detail add constraint trans_unrecognized_detail_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_unrecognized add constraint trans_unrecognized_FK1 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.mstr_approval_scope_pattern add constraint mstr_approval_scope_pattern_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_auditor add constraint trans_auditor_FK2 foreign key (trans_audit_team_id,trans_audit_id) references tests.trans_audit_team (trans_audit_team_id,trans_audit_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_auditor add constraint trans_auditor_FK3 foreign key (trans_audit_id) references tests.trans_audit (trans_audit_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_auditor add constraint trans_auditor_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_audit_team add constraint trans_audit_team_FK1 foreign key (trans_audit_id) references tests.trans_audit (trans_audit_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_audit_team add constraint trans_audit_team_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_audit add constraint trans_audit_FK1 foreign key (audit_history_id,mstr_audit_std_id) references tests.history_mstr_audit_std (history_id,mstr_audit_std_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_audit add constraint trans_audit_FK2 foreign key (mstr_stakeholder_id) references tests.mstr_stakeholder (mstr_stakeholder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_audit add constraint trans_audit_FK3 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_audit add constraint trans_audit_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_task_risk add constraint trans_task_risk_FK1 foreign key (mstr_task_id) references tests.mstr_task (mstr_task_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_task_risk add constraint trans_task_risk_FK2 foreign key (risk_id) references tests.trans_risk (trans_risk_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_task_risk add constraint trans_task_risk_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_detail_risk add constraint trans_order_detail_risk_FK1 foreign key (risk_id) references tests.trans_risk (trans_risk_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_detail_risk add constraint trans_order_detail_risk_FK2 foreign key (trans_order_detail_id) references tests.trans_order_detail (trans_order_detail_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_detail_risk add constraint trans_order_detail_risk_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_prevention_detail add constraint trans_prevention_detail_FK1 foreign key (trans_risk_id) references tests.trans_risk (trans_risk_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_prevention_detail add constraint trans_prevention_detail_FK2 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_prevention_detail add constraint trans_prevention_detail_FK3 foreign key (trans_prevention_id,trans_risk_id) references tests.trans_prevention (trans_prevention_id,trans_risk_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_prevention_detail add constraint trans_prevention_detail_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_prevention add constraint trans_prevention_FK1 foreign key (trans_risk_id) references tests.trans_risk (trans_risk_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_prevention add constraint trans_prevention_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_risk add constraint trans_order_risk_FK1 foreign key (trans_risk_id) references tests.trans_risk (trans_risk_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_risk add constraint trans_order_risk_FK2 foreign key (trans_order_id) references tests.trans_order (trans_order_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_risk add constraint trans_order_risk_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_equipment_lent add constraint trans_equipment_lent_FK1 foreign key (equipment_history_id,mstr_equipment_id) references tests.history_mstr_equipment (history_id,mstr_equipment_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_equipment_lent add constraint trans_equipment_lent_FK2 foreign key (info_staff_id) references tests.info_staff (info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_observer_preventive add constraint trans_observer_preventive_FK2 foreign key (trans_observer_disposal_id) references tests.trans_observer_disposal (trans_observer_disposal_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_observer_preventive add constraint trans_observer_preventive_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_observer_disposal add constraint trans_observer_disposal_FK1 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint_stakeholder_adapter add constraint trans_complaint_stakeholder_adapter_FK1 foreign key (mstr_stakeholder_id) references tests.mstr_stakeholder (mstr_stakeholder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint_stakeholder_adapter add constraint trans_complaint_stakeholder_adapter_FK2 foreign key (trans_complaint_id) references tests.trans_complaint (trans_complaint_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint_stakeholder_adapter add constraint trans_complaint_stakeholder_adapter_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint_equipment_adapter add constraint trans_complaint_equipment_adapter_FK1 foreign key (mstr_equipment_id) references tests.mstr_equipment (mstr_equipment_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint_equipment_adapter add constraint trans_complaint_equipment_adapter_FK2 foreign key (trans_complaint_id) references tests.trans_complaint (trans_complaint_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint_equipment_adapter add constraint trans_complaint_equipment_adapter_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_recurrence_prevention add constraint trans_recurrence_prevention_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_complaint add constraint trans_complaint_FK1 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_inspect_imp_file add constraint trans_inspect_imp_file_FK1 foreign key (trans_file_reminder_id) references tests.trans_file_reminder (trans_file_reminder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_inspect_imp_file add constraint trans_inspect_imp_file_FK2 foreign key (trans_inspect_record_id) references tests.trans_inspect_record (trans_inspect_record_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_inspect_imp_file add constraint trans_inspect_imp_file_FK3 foreign key (trans_file_id) references tests.trans_file (trans_file_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.mstr_inspection add constraint mstr_inspection_FK6 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_assign add constraint info_assign_FK1 foreign key (info_office_id) references tests.info_office (info_office_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_assign add constraint info_assign_FK2 foreign key (info_department_id) references tests.info_department (info_department_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_assign add constraint info_assign_FK3 foreign key (info_staff_id) references tests.info_staff (info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_assign add constraint info_assign_FK4 foreign key (info_position_id) references tests.info_position (info_position_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_assign add constraint info_assign_FK5 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_staff_access_permission add constraint info_staff_access_permission_FK1 foreign key (info_staff_id) references tests.info_staff (info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_staff_access_permission add constraint info_staff_access_permission_FK2 foreign key (info_access_path_id) references tests.info_access_path (info_access_path_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_staff_access_permission add constraint info_staff_access_permission_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.info_app add constraint info_app_FK1 foreign key (info_company_id) references tests.info_company (info_company_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_work_record_visiter add constraint trans_work_record_visiter_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rec_visiter add constraint trans_purchase_rec_visiter_FK1 foreign key (trans_visiter_id) references tests.trans_visiter (trans_visiter_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rec_visiter add constraint trans_purchase_rec_visiter_FK2 foreign key (trans_purchase_rec_id) references tests.trans_purchase_rec (trans_purchase_rec_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rec_visiter add constraint trans_purchase_rec_visiter_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_visiter add constraint trans_visiter_FK1 foreign key (trans_container_id) references tests.trans_container (trans_container_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_visiter add constraint trans_visiter_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_item_actual_size add constraint mstr_item_actual_size_FK1 foreign key (mstr_item_size_kind_id) references tests.mstr_item_size_kind (mstr_item_size_kind_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_certificate add constraint trans_certificate_FK1 foreign key (trans_file_id) references tests.trans_file (trans_file_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_certificate add constraint trans_certificate_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rec add constraint trans_purchase_rec_FK1 foreign key (trans_purchase_detail_id) references tests.trans_purchase_detail (trans_purchase_detail_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rec add constraint trans_purchase_rec_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_certification add constraint trans_purchase_certification_FK1 foreign key (trans_purchase_rec_id) references tests.trans_purchase_rec (trans_purchase_rec_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_certification add constraint trans_purchase_certification_FK2 foreign key (trans_certificate_id) references tests.trans_certificate (trans_certificate_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_certification add constraint trans_purchase_certification_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rez add constraint trans_purchase_rez_FK1 foreign key (trans_purchase_detail_id) references tests.trans_purchase_detail (trans_purchase_detail_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_rez add constraint trans_purchase_rez_FK2 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_detail add constraint trans_purchase_detail_FK1 foreign key (history_id,mstr_item_id) references tests.history_mstr_item (history_id,mstr_item_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_detail add constraint trans_purchase_detail_FK2 foreign key (trans_resorce_plan_id) references tests.trans_resorce_plan (trans_resorce_plan_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_detail add constraint trans_purchase_detail_FK3 foreign key (trans_purchase_id) references tests.trans_purchase (trans_purchase_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase_detail add constraint trans_purchase_detail_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_detail add constraint trans_order_detail_FK1 foreign key (history_mstr_item_id,mstr_item_id) references tests.history_mstr_item (history_id,mstr_item_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_detail add constraint trans_order_detail_FK2 foreign key (trans_order_id) references tests.trans_order (trans_order_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order_detail add constraint trans_order_detail_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_shipping_order_detail add constraint trans_shipping_order_detail_FK1 foreign key (trans_order_detail_id) references tests.trans_order_detail (trans_order_detail_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_shipping_order_detail add constraint trans_shipping_order_detail_FK2 foreign key (trans_shipping_id) references tests.trans_ship_order (trans_shipping_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_shipping_order_detail add constraint trans_shipping_order_detail_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.trans_resorce_plan add constraint trans_resorce_plan_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase add constraint trans_purchase_FK1 foreign key (contact_history_id,mstr_stakeholder_contact_id) references tests.history_mstr_stakeholder_contact (history_id,mstr_stakeholder_contact_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase add constraint trans_purchase_FK2 foreign key (supplier_history_id,mstr_stakeholder_id) references tests.history_mstr_stakeholder (history_id,mstr_stakeholder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_purchase add constraint trans_purchase_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order add constraint trans_order_FK1 foreign key (contact_history_id,mstr_stakeholder_concat_id) references tests.history_mstr_stakeholder_contact (history_id,mstr_stakeholder_contact_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order add constraint trans_order_FK2 foreign key (customer_history_id,mstr_stakholder_id) references tests.history_mstr_stakeholder (history_id,mstr_stakeholder_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.trans_order add constraint trans_order_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.mstr_equipment add constraint mstr_equipment_FK1 foreign key (mstr_equipment_category_id) references tests.mstr_equipment_kind (mstr_equipment_kind_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_equipment add constraint mstr_equipment_FK2 foreign key (mstr_item_id) references tests.mstr_item (mstr_item_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_equipment add constraint mstr_equipment_FK3 foreign key (mstr_location_id) references tests.mstr_location (mstr_location_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_equipment add constraint mstr_equipment_FK4 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_stakeholder_contact add constraint mstr_stakeholder_contact_FK1 foreign key (mstr_shipping_kind_id) references tests.mstr_shipping_kind (mstr_shipping_kind_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_stakeholder_contact add constraint mstr_stakeholder_contact_FK2 foreign key (contact_person_appellations_id) references tests.shared_appellations (shared_appellations_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_stakeholder_contact add constraint mstr_stakeholder_contact_FK3 foreign key (department_appellations_id) references tests.shared_appellations (shared_appellations_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_stakeholder_contact add constraint mstr_stakeholder_contact_FK4 foreign key (office_appellations_id) references tests.shared_appellations (shared_appellations_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_stakeholder_contact add constraint mstr_stakeholder_contact_FK5 foreign key (info_address_id) references tests.info_address (info_address_id) DEFERRABLE INITIALLY DEFERRED;
...
alter table tests.mstr_staff_license add constraint mstr_staff_license_FK2 foreign key (mstr_license_id) references tests.mstr_license (mstr_license_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_staff_license add constraint mstr_staff_license_FK3 foreign key (update_user_history_id,update_user_id) references tests.history_info_staff (history_id,info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_staff_capability add constraint mstr_staff_capability_FK1 foreign key (info_staff_id) references tests.info_staff (info_staff_id) DEFERRABLE INITIALLY DEFERRED;
alter table tests.mstr_staff_capability add constraint mstr_staff_capability_FK2 foreign key (mstr_capability_id) references tests.mstr_capability (mstr_capability_id) DEFERRABLE INITIALLY DEFERRED;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.shared_dictionary_value_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_shared_dictionary_value BEFORE INSERT OR UPDATE OR DELETE ON tests.shared_dictionary_value FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.shared_language_code_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.mstr_inspection_kind_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_mstr_inspection_kind BEFORE INSERT OR UPDATE OR DELETE ON tests.mstr_inspection_kind FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_mstr_inspection_kind WHERE mstr_inspection_kind_id=NEW.mstr_inspection_kind_id;
        IF (revisions >= 0) THEN
            IF (
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.mstr_spec_measurement_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_mstr_spec_measurement BEFORE INSERT OR UPDATE OR DELETE ON tests.mstr_spec_measurement FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_mstr_spec_measurement WHERE mstr_spec_measurement_id=NEW.mstr_spec_measurement_id;
        IF (revisions >= 0) THEN
            IF (
        ...
        ELSE
            NEW.revision := 1;
        END IF;
        INSERT INTO tests.history_mstr_spec_measurement (
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.mstr_packing_spec_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_mstr_packing_spec BEFORE INSERT OR UPDATE OR DELETE ON tests.mstr_packing_spec FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_mstr_packing_spec WHERE mstr_packing_spec_id=NEW.mstr_packing_spec_id;
        IF (revisions >= 0) THEN
            IF (
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.mstr_envelope_measurement_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_mstr_envelope_measurement BEFORE INSERT OR UPDATE OR DELETE ON tests.mstr_envelope_measurement FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_mstr_envelope_measurement WHERE mstr_envelope_measurement_id=NEW.mstr_envelope_measurement_id;
        IF (revisions >= 0) THEN
            IF (
        ...
        ELSE
            NEW.revision := 1;
        END IF;
        INSERT INTO tests.history_mstr_envelope_measurement (
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.mstr_equipment_envelope_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_mstr_equipment_envelope BEFORE INSERT OR UPDATE OR DELETE ON tests.mstr_equipment_envelope FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_mstr_equipment_envelope WHERE mstr_equipment_envelope_id=NEW.mstr_equipment_envelope_id;
        IF (revisions >= 0) THEN
            IF (
        ...
        ELSE
            NEW.revision := 1;
        END IF;
        INSERT INTO tests.history_mstr_equipment_envelope (
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_shipping_order_detail_record_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.hrchy_mstr_document_content_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.mstr_inspection_operation_task_id,
                OLD.mstr_inspection_operation_id,
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.mstr_equipment_provision_id,
                OLD.info_provision_id,
                OLD.mstr_equipment_id,
                OLD.start_at,
                OLD.stop_at,
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.mstr_inspection_formula_id,
                OLD.formula_class,
                OLD.arg_class,
                OLD.type_class,
                OLD.format_class,
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_inspection_report_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.info_position_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_info_position BEFORE INSERT OR UPDATE OR DELETE ON tests.info_position FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_info_position WHERE info_position_id=NEW.info_position_id;
        IF (revisions >= 0) THEN
            IF (
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.mstr_audit_std_checkitem_id,
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_complaint_stakeholder_adapter_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_complaint_equipment_adapter_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_complaint_order_adapter_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.info_staff_access_permission_id,
                OLD.info_access_path_id,
                OLD.info_staff_id,
                OLD.permit,
                OLD.symbol,
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_work_record_visiter_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_purchase_rec_visiter_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.mstr_item_actual_size_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
$BODY$
LANGUAGE plpgsql VOLATILE;
CREATE TRIGGER trg_01_updatetimes_mstr_item_actual_size BEFORE INSERT OR UPDATE OR DELETE ON tests.mstr_item_actual_size FOR EACH ROW EXECUTE
...
BEGIN
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        SELECT Max(revision) INTO revisions FROM tests.history_mstr_item_actual_size WHERE mstr_item_actual_size_id=NEW.mstr_item_actual_size_id;
        IF (revisions >= 0) THEN
            IF (
                NEW.mstr_item_actual_size_id,
                NEW.mstr_item_id,
                NEW.mstr_item_size_kind_id,
                NEW.size_value,
                NEW.detail,
        ...
        ELSE
            NEW.revision := 1;
        END IF;
        INSERT INTO tests.history_mstr_item_actual_size (
            mstr_item_actual_size_id,
            mstr_item_id,
            mstr_item_size_kind_id,
            size_value,
            detail,
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_work_record_certificate_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
...
BEGIN
    IF (TG_OP = 'UPDATE') THEN
        ...
        RETURN NEW;
    ELSEIF (TG_OP='INSERT') THEN
        NEW.trans_shipping_order_detail_id := gen_random_uuid();
        NEW.update_at:=now();
        RETURN NEW;
    ELSEIF (TG_OP = 'DELETE') THEN
        RETURN OLD;
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.mstr_item_operation_task_id,
                OLD.mstr_operation_task_id,
                OLD.mstr_item_id,
                OLD.sequence,
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                OLD.mstr_equipment_id,
                OLD.mstr_item_id,
                OLD.mstr_equipment_category_id,
                OLD.code,
                OLD.control_code,
                OLD.label_code,
                OLD.mstr_location_id,
    ...
    IF (TG_OP = 'UPDATE') OR (TG_OP='INSERT') THEN
        ...
        IF (revisions >= 0) THEN
            IF (
                ...
                NEW.mstr_stakeholder_id,
                NEW.code,
                NEW.office_appellations_id,
                NEW.department_appellations_id,
                NEW.contact_person_appellations_id,
                NEW.mail,
                NEW.info_address_id,
                NEW.mstr_shipping_kind_id,
                NEW.symbol,
                ...
                OLD.mstr_stakeholder_contact_id,
                OLD.mstr_stakeholder_id,
                OLD.code,
                OLD.office_appellations_id,
                OLD.department_appellations_id,
                OLD.contact_person_appellations_id,
                OLD.mail,
                OLD.info_address_id,
                OLD.mstr_shipping_kind_id,
                OLD.symbol,
        ...
        INSERT INTO tests.history_mstr_stakeholder_contact (
            ...
            mstr_stakeholder_id,
            code,
            office_appellations_id,
            department_appellations_id,
            contact_person_appellations_id,
            mail,
            info_address_id,
            mstr_shipping_kind_id,
            revision,
