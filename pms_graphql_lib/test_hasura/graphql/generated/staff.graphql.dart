...
class Variables$Query$StaffQuery {
  factory Variables$Query$StaffQuery({
    ...
    List<Input$tests_info_staff_order_by>? order_by,
  ...
  factory Variables$Query$StaffQuery.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('order_by')) {
      ...
      result$data['order_by'] = (l$order_by as List<dynamic>?)
          ?.map(
            (e) => Input$tests_info_staff_order_by.fromJson(
  ...
  List<Input$tests_info_staff_order_by>? get order_by =>
      (_$data['order_by'] as List<Input$tests_info_staff_order_by>?);
  ...
  TRes call({
    ...
    Variables$Query$StaffQuery._({
      ...
      if (order_by != _undefined)
        'order_by': (order_by as List<Input$tests_info_staff_order_by>?),
    }),
  );
}
    ...
    OperationDefinitionNode(
      ...
      variableDefinitions: [
        ...
        VariableDefinitionNode(
          ...
          type: ListTypeNode(
            type: NamedTypeNode(
              name: NameNode(value: 'tests_info_staff_order_by'),
              isNonNull: true,
            ),
            isNonNull: false,
          ),
