...
class RowUndoCommand implements IUndoCommand {
  ...
  ///コンストラクタ
  ///TrinaRowからモデルを生成する
  RowUndoCommand(TrinaRow currentRow, TrinaRow newRow, TrinaRowCallback execute)
...
class RowModel {
  ...
  RowModel._(this.rowKey, this.parentRowKey, this.expanded, this.attributes);
  ...
  factory RowModel.to(TrinaRow row) {
    ...
    return RowModel._(rowKey, parentKey, isExpanded, json);
  }
}
